...
source somebody chose, plus every worklet whose loop is as long as the audio — tape, pop,
scatter, crush and shift. Such a kernel that the bench does not carry is a
