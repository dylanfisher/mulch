...
| ----------------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| **lib**           | `src/lib`           | Pure helpers — DSP maths, WAV encoding, zip, time↔sample conversion. No state, no `AudioContext`, and no DOM but the one draw a look that takes a slot in the chain carries beside its own declaration (0280). This is the well-tested layer. | nothing in this table                 |
