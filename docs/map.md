...
| ----------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| **lib**           | `src/lib`           | Pure helpers — DSP maths, WAV encoding, zip, time↔sample conversion. No state, no `AudioContext`, and no DOM but the one draw a look that takes a slot in the chain carries beside its own declaration — and the tile such a draw bakes once and holds, which is a file of its own (`moireGrain.ts`, 0280, 0285, 0286) — and, once that contract file stands at the cap, a whole look of its own: terms, maths and draw together (`moireBand.ts`, 0287; `moireSquash.ts`, 0288; `moireDouble.ts`, 0289; `moireEchoes.ts`, 0294; and, cut rather than passed, `moireShards.ts`, 0296) — with the one share every such pass lays its picture at in a module they all reach and none of them is (`moireWeigh.ts`, 0289). This is the well-tested layer. | nothing in this table                 |
| **audio**         | `src/audio`         | The Web Audio graph: the parameter registry, effect plugins, worklets, `buildDeckChain`. Written against `BaseAudioContext` so live and offline share one implementation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | lib                                   |
| **workers**       | `src/workers`       | Worker entrypoints — WAV encode, BPM/onset analysis. Message-passing only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | lib                                   |
| **state**         | `src/state`         | The session store, selectors, IndexedDB persistence, and the one durable session shape.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | lib, audio                            |
