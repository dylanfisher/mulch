 ...
 *   of its own ramp, so still water is dark and cool and only its crests are lit (0329, 0332).
...
export const water: Scene = {
  ramp: ["--scene-water-deep", "--drift-cool", "--primary", "--screen-blue", "--scene-water-lit"],
  ground: (x, y, terms) => {
