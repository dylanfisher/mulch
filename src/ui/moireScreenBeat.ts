 ...
 *   cell → src/ui/moireScreenTile.ts, this file's only caller. Where a cell's read is cut into a
 *   mark and the rack's passes run over it → `cellGrid`, src/ui/moireScreenCells.ts. The marks
 ...
 * (`cellGrid`), at another cell size. Never a second alphabet: what the second lattice says is
