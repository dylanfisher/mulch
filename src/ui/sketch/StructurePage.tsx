...
export const SKETCH_STRUCTURES: readonly StructureEntry[] = [
  {
    ...
    trades:
      "the picture's constant weight. Every other row is counted so the field's mean holds at PICTURE_FLOOR.value whatever a yard holds, down to the count that can still reach it (gratingDepth), and a row cut outside that count darkens the picture by exactly what it cuts — the automator would be the one effect that makes the drift heavier.",
    built:
