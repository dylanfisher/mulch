...
describe("MarksPage mounts the bench", () => {
   ...
   * bloom's with 0349, the rows' with 0350, the beat's with 0351, the scatter's with 0352. */
  it("mounts every entry, with one id apiece", () => {
    expect(SKETCH_MARKS.length).toBe(2);
    const landed = ["ground", "echoes", "bloom", "rows", "beat", "scatter"];
