 ...
 *   The surface the ground eight argue with → src/ui/PlayerCard.tsx. The picture the drift twelve
...
function DriftIntro() {
  return (
    <p className="max-w-3xl type-body text-muted-foreground">
      ...
      is a bake and a frame is a fill — so the twelve are a plan&apos;s worth of parts and not
      twelve wishes. The stand-in is two gratings a pixel apart in pitch, which is what the real
