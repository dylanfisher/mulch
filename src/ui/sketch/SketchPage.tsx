 ...
 *   thing it gives up to make it. Two benches are spent: the grid won how a song is played and is
 *   the card's own section (0275, src/ui/PlayerGrid.tsx), and the switchboard won how the ground
 *   moves and is the fold's own three rows of words (0277, src/ui/PlayerBed.tsx).
