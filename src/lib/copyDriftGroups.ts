  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        wild: "max",
        label: "Strips",
        hint: "How many pictures may animate together before each is painted more slowly.",
      },
      {
        id: "pace.loadHz",
        wild: "max",
        label: "Under load",
        hint: "The slowest a picture is painted because others stand beside it, in frames a second.",
      },
      {
        id: "pace.perFrame",
        wild: "max",
        label: "Per frame",
        hint: "How many pictures may paint inside one frame; the rest paint on the next.",
      },
    ],
  },
