/**
 * @role The second, quieter landing one landing may throw: the odds it throws one, and how loud
 *   that one is against it. Declared here rather than in src/lib/player.ts because that file is at
 *   the hard cap and each family of the spec's numbers now sits in a module of its own beside what
 *   reads it (0045, P119, P123).
...
/**
 * The two fields of a `PlayerSpec` that say what a landing throws, arranged as the travel's four
