 ...
 *   nothing is covered outside a cell, and that the ramp onto them starts at the phase mark and
 *   comes round beneath it at its top (0344).
 */
import { describe, expect, it } from "vitest";

import { GLYPH_COUNT, GLYPH_PHASE, markAt, markCoverage, markWeight } from "./moireGlyph.ts";
