...
/**
 * What that period is counted in: the jumps the pattern takes, the parts the song stands in, or the
 * whole rounds the song comes round on (0192, P158, P170).
 *
 * A choice and not a further amount, for the reason the bias is an amount and not a choice: these
 * are three different clocks rather than three points on one, and a spec carrying a number per unit
 * would be three periods disagreeing about when the ground moves (principle 1, 0162 read the other
 * way round).
 *
